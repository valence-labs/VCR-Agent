...
class DTIVerificationArgs(BaseModel):
    ...
    interaction_type: Optional[Literal["inhibitor", "agonist", "antagonist", "activator", "blocker"]] = Field(default=None, description="Type of interaction (inhibitor|agonist|antagonist|activator|blocker)")
    strength: Optional[float] = Field(default=None, description="Predicted strength of the interaction in uM")
